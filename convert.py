...
my_md_files = exclude_files(files_list=all_my_md_files)
createUniqueMdFile(file_list=my_md_files, my_file_name=md_file_name)
...
pdf.save("pdf_documentation/" + pdf_file_name)